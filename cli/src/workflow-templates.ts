    ...
    workflow: {
      nodes: [
        ...
        },
        {
          ...
          output_collections: ["competitive_summary"],
          required_skills: SKILLS,
    ...
    workflow: {
      nodes: [
        ...
        },
        {
          ...
          required_skills: SKILLS,
          prompt: "Produce an executive-ready campaign performance report. Include: headline metrics summary, channel-level breakdown with trend commentary, key wins and concerns, and 3–5 specific budget reallocation or optimization recommendations backed by the data.",
        },
      ],
    },
  },
    ...
    workflow: {
      nodes: [
        ...
        },
        {
          ...
          required_skills: SKILLS,
          prompt: "Produce a prioritized user research insights report: top 5 themes with evidence and severity weighting, sentiment summary, churn and expansion signals, recommended product actions per theme, and open questions for follow-up research.",
        },
      ],
    },
  },
    ...
    workflow: {
      nodes: [
        ...
        },
        {
          ...
          required_skills: SKILLS,
          prompt: "Compose the final code review report: approve/request-changes recommendation, blocking quality issues, blocking security findings, non-blocking suggestions, and documentation coverage gaps. Organize by priority. Include a merge readiness summary with any conditions that must be met.",
        },
      ],
    },
  },
    ...
    workflow: {
      nodes: [
        ...
        },
        {
          ...
          required_skills: SKILLS,
          prompt: "Produce an integration evaluation report: capability fit summary, risk assessment with severity ratings, recommended implementation approach, authentication strategy, error handling and retry patterns, rate limit management approach, and a go/no-go recommendation with conditions.",
        },
      ],
    },
  },
    ...
    workflow: {
      nodes: [
        ...
        },
        {
          ...
          required_skills: SKILLS,
          prompt: "Produce a compliance action plan: full obligation inventory with control status summary, prioritized remediation actions with owner roles, recommended due dates, evidence artifacts needed per obligation, and a readiness score with key blockers. Format for use as an audit preparation document.",
        },
      ],
    },
  },
    ...
    workflow: {
      nodes: [
        ...
        },
        {
          ...
          output_collections: ["review_summary"],
          required_skills: SKILLS,
    ...
    workflow: {
      nodes: [
        ...
        },
        {
          ...
          required_skills: SKILLS,
          prompt: "Produce a structured financial due diligence report: executive summary with key findings, financial performance overview by period, ratio analysis with peer benchmarks where possible, trend narrative, material risks and red flags, and investment or decision considerations with supporting data.",
        },
      ],
    },
  },
    ...
    workflow: {
      nodes: [
        ...
        },
        {
          ...
          required_skills: SKILLS,
          prompt: "Produce a structured technical analysis report: trend summary (direction, strength, stage), momentum posture (overbought/oversold, divergences), key price levels to watch (support, resistance, breakout triggers), potential setup scenarios (continuation or reversal), and a risk/reward framing with suggested stop and target zones.",
        },
      ],
    },
  },
